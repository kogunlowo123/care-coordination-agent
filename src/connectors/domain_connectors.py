"""Care Coordination Agent - Domain-Specific Connectors."""
...
class EpicEhrConnector:
    """Domain-specific connector for epic ehr integration with Care Coordination Agent."""
...
class CernerEhrConnector:
    """Domain-specific connector for cerner ehr integration with Care Coordination Agent."""
...
class AllscriptsConnector:
    """Domain-specific connector for allscripts integration with Care Coordination Agent."""
...
class FhirServerConnector:
    """Domain-specific connector for fhir server integration with Care Coordination Agent."""
...
class ClearinghouseConnector:
    """Domain-specific connector for clearinghouse integration with Care Coordination Agent."""
