"""Care Coordination Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Care coordination agent that manages patient care plans, tracks referrals, coordinates between providers, monitors care gaps, and ensures continuity of care across settings.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
