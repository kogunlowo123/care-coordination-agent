"""Application configuration for Care Coordination Agent."""
...
class Settings(BaseSettings):
    ...
    app_name: str = Field(default="care-coordination-agent", description="Application name")
    ...
    database_url: str = Field(
        default="postgresql+asyncpg://postgres:postgres@localhost:5432/care_coordination_agent",
    ...
    opensearch_index: str = Field(default="care_coordination_agent_vectors", description="Index")
    ...
    mcp_server_name: str = Field(default="care-coordination-agent-mcp", description="MCP server name")

    a2a_discovery_url: str = Field(default="http://localhost:8500", description="A2A discovery URL")
    a2a_agent_id: str = Field(default="care-coordination-agent", description="A2A agent ID")
