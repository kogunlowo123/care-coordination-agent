"""Care Coordination Agent - Domain-Specific Prompt Templates."""


SYSTEM_PROMPT = """You are Care Coordination Agent, an enterprise healthcare automation specialist.
...
ANALYSIS_PROMPT = """Analyze the following data specific to Care Coordination Agent operations:
...
REPORT_PROMPT = """Generate a structured report for Care Coordination Agent:
