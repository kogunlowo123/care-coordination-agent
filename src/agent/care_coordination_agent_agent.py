"""Care Coordination Agent - Main Agent Implementation."""
...
class CareCoordinationAgentAgent:
    """
    ...
    def __init__(self):
        ...
        self.interoperability_enabled = True
        self._tool_dispatch = {
            "create_care_plan": self.tools.create_care_plan,
            "track_referral": self.tools.track_referral,
            "identify_care_gaps": self.tools.identify_care_gaps,
            "coordinate_transition": self.tools.coordinate_transition,
            "generate_summary": self.tools.generate_summary,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['care', 'coordination', 'compliance', 'interoperability'],
        )
    ...
    async def process_message(self, request: ChatRequest, user_id: str) -> ChatResponse:
        ...
        rag_results = await self.rag_pipeline.retrieve(
            ...
            top_k=5,
            filters={"user_id": user_id, "domain": "healthcare"},
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            ...
            "identify_care_gaps": ['identify', 'care', 'gaps'],
